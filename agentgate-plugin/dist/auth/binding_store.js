...
export class BindingStore {
    ...
    /** 查询绑定：按信道类型 + 用户 ID */
    getBinding(channel, channelUserId) {
        return this.load().find(b => b.channel_type === channel && b.channel_user_id === channelUserId && b.status === 'active');
    }
    /** 查询绑定：按绑定 ID */
    getById(id) {
...
//# sourceMappingURL=binding_store.js.map